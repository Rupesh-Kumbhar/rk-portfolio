...
function TyPro(){
    return (
        <div className="pro-card-width-33 p-0">
            ...
            <div className="row m-0 justify-content-evenly">
                ...
                <h4 className="text-center mb-4 ">
                    ...
                    <div className="card shadow pro-card-border transform-hover">
                        ...
                        <img src={`${process.env.PUBLIC_URL}/assets/projects-images/college-pro/VoiceAssistance-img.svg`} className="card-img-top w-75 mx-auto mt-4" alt="pro img" />
                            <div className="card-body">
                                ...
                                <div className="col-sm-12 p-0 text-center">
                                    <button type="button" className="btn btn-info" data-bs-toggle="modal" data-bs-target="#staticBackdropTy">
                                        View More
                                    </button>
                                </div>
                            </div>
            ...
            {/* <!-- Modal --> */}
            <div className="modal fade modal-bg-color " id="staticBackdropTy" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div className="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h3 className="modal-title main-heading-pro" id="staticBackdropLabel">Voice Assistance for Windows</h3>
                        ...
                        <div className="modal-body">
                            <div className="col-sm-12 p-0 row m-0">
                                ...
                                <div className="col-sm-5 p-0 row m-0 display-in-mb">
                                    <img src={`${process.env.PUBLIC_URL}/assets/projects-images/college-pro/VoiceAssistance-img.svg`} className="card-img-top w-100 mx-auto mt-4" alt="pro img" />
                                </div>
