            ...
            <div className="row m-0 justify-content-evenly">
                ...
                <h4 className="text-center mb-4 "> 
                    ...
                    <div className="card shadow pro-card-border transform-hover">
                        ...
                        <img src="./assets/projects-images/college-pro/BMI-img.svg" className="card-img-top w-75 mx-auto" alt="pro img" />
                        ...
                        <div className="modal-body">
                            <div className="col-sm-12 p-0 row m-0">
                                ...
                                <div className="col-sm-5 p-0 row m-0 display-in-mb">
                                    <img src="./assets/projects-images/college-pro/BMI-img.svg" className="card-img-top w-100 mx-auto" alt="pro img" />
                                </div>
